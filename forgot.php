...
<div class="auto-style15">
	...
	<div class="auto-style16" style="left: 0px; top: -28px">
		...
		<div class="mybhai_menu clearfix">
			...
			<ul>
				...
				<li><a href="rules" ><span>HOW TO PLAY</span></a></li>
	...
	<div><img src="curbtp.gif" width="995" height="9" border="0" /></div>
			...
			<div class="clearfix ML15 MR15" style="border-bottom:5px solid #000">
				...
				<div class="auto-style8" style="width: 321px; height: 412px;">
					...
					<img src="men_img.jpg" width="42" height="40" alt="" class="FL MR15" />Change 
							Password</span></div>
...
<!-- </p> -->
				...
				<div class="auto-style9" style="width: 580px; height: 412px;">

					&nbsp;<div class="imgctr">

						<div class='auto-style10'>Our Lead Sponsor<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbldata" style="height: 316px">
					...
					<div class="PL15 FL PT5" style="width: 879px">
						...
						<div class="FL" style="width:874px; height: 106px;">
							...
							<ul>
								...
								<li class="auto-style5">This Area is reserved 
